<%-- 
    Document   : header
    Created on : Mar 21, 2020, 8:48:44 PM
    Author     : yiyil
--%>
                                                            ...
                                                            <div class="m-card-user m-card-user--skin-light">
                                                                ...
                                                                <div class="m-card-user__details">
                                                                    <span class="m-card-user__name m--font-weight-500">
                                                                         ${sessionScope.Account.getString('username')}
                                                                    </span>
                                                                    <a href="" class="m-card-user__email m--font-weight-300 m-link">
                                                                        ${sessionScope.Account.getString('email')}
                                                                    </a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                            ...
                                                            <div class="m-dropdown__content">
                                                                <ul class="m-nav m-nav--skin-light">
                                                                    ...
                                                                    <li class="m-nav__item">
                                                                        <c:url value="MainController" var="Profile" >
                                    ...
                                    <ul class="m-menu__nav  m-menu__nav--submenu-arrow ">
                                        ...
                                        <li class="m-menu__item  m-menu__item--submenu m-menu__item--tabs"  data-menu-submenu-toggle="tab" aria-haspopup="true">
                                            ...
                                            <div class="m-menu__submenu m-menu__submenu--classic m-menu__submenu--left m-menu__submenu--tabs">
                                                ...
                                                <ul class="m-menu__subnav">
                                                    <li class="m-menu__item "  data-redirect="true" aria-haspopup="true">
                                                        <a  href="MainController?action=Attendance" class="m-menu__link ">
                                                            <i class="m-menu__link-icon flaticon-graphic-2"></i>
                                                            <span class="m-menu__link-text">
                                                                Schedule on current week
                                                            </span>
                                                        </a>
                                                    </li>
