...
namespace FaceApi2.Models
{
    public partial class FaceIOContext : DbContext
    {
        ...
        public virtual DbSet<FaceDetector> FaceDetector { get; set; }
        public virtual DbSet<MappingFace> MappingFace { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<FaceDetector>(entity =>
            {
                entity.Property(e => e.Id).HasColumnName("ID");

                entity.Property(e => e.CameraId).HasColumnName("CameraID");

                entity.Property(e => e.TimeCaptured).HasColumnType("datetime");
                ...
                entity.HasOne(d => d.Camera)
                    .WithMany(p => p.FaceDetector)
                    .HasForeignKey(d => d.CameraId)
                    .HasConstraintName("FK_FaceDetector_Camera");
            });

            modelBuilder.Entity<MappingFace>(entity =>
            {
                entity.Property(e => e.Id).HasColumnName("ID");
                ...
                entity.HasOne(d => d.Image)
                    .WithMany(p => p.MappingFace)
                    .HasForeignKey(d => d.ImageId)
                    .HasConstraintName("FK_MappingFace_FaceDetector");

                entity.HasOne(d => d.UsernameNavigation)
                    .WithMany(p => p.MappingFace)
                    .HasForeignKey(d => d.Username)
                    .HasConstraintName("FK_MappingFace_Children");
            });
