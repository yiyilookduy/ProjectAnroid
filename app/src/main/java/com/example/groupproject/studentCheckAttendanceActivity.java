        ...
        weekSelector.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                try {
                    ...
                    String attendanceDataOfSpecificWeek = new getStudentAttendanceDataUrl().execute(constants.url+"/Attendance/GetScheduleOnWeek?studentId="+username+"&date="+text).get();
