    ...
    private void PostTicketToServerEvent() {
        buttonCreateTicket.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new PostCreateTicketToServer(studentId, teacherId,MessageContent).execute(constants.url+"/Ticket/CreateTicket?studentId="+ studentId+"&teacherId="+teacherId+"&content="+MessageContent);
            }
        });
    }
